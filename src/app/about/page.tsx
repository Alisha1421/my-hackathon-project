...
import AboutImage from "../../../public/images/Aboutsecond.png";
    ...
    <div>
      ...
      <div className="px-8 py-12">
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-[70%] h-auto md:h-[380px] border border-black bg-[#2A254B] text-white px-4 md:px-12 py-6 md:py-12 flex flex-col justify-between">
            <div>
            ...
            <div className="my-4 md:my-0">
              <p className="text-lg md:text-base md:text-left">
                A global brand with humble local beginnings, our story began in
                a small, cozy studio tucked away in South London in the early
                months of 2014. What started as a passionate dream quickly
                evolved into a journey of creativity, innovation, and dedication
                to excellence, laying the foundation for a brand that would
          ...
          <div className="w-full md:w-[30%] h-auto md:h-[380px] bg-white flex single_chair_image">
            <img
