  ...
  return (
    <div className="p-4 w-full h-auto">
      ...
      <div className="flex justify-between items-center py-2">
        ...
        <div className="sm:hidden md:block search-icon">
        ...
        <div className="sm:hidden md:flex gap-4 cart-icon">
          <Link href="/Cart">
        ...
        <div className="flex items-center gap-4 md:hidden extra-cross">
          <CiSearch size={25} className="text-[#2A254B]" />
          <button
