...
const Footer = () => {
  return (
    <>
      <div className="px-6 md:px-12 py-8 bg-[#2A254B] mt-8 text-white">
        <div className="flex flex-wrap gap-12 md:gap-[100px] lg:gap-[200px] text-white">
          {/* Menu Section */}
          <div className="text-gray-500 w-full sm:w-auto text-white">
            <h1 className="text-lg md:text-xl font-bold">Menu</h1>
            <div className="space-y-2">
              <h1>
                <Link href={"#newProduct"}>New Arrivals</Link>
              </h1>
              <h1>
                <Link href={"#newProduct"}>Best sellers</Link>
              </h1>
              <h1>
                <Link href={"#newProduct"}>Recently viewed</Link>
              </h1>
              <h1>
                <Link href={"#newProduct"}>Popular this week</Link>
              </h1>
              <h1>
                <Link href={"#newProduct"}>All Products</Link>
              </h1>
            </div>
          </div>
          ...
          <div className="text-gray-500 w-full sm:w-auto text-white">
            ...
            <div className="space-y-2">
              ...
              <h1>
                <Link href={"#products"}>Homeware</Link>
              </h1>
              <h1>
          ...
          <div className="text-white w-full sm:w-auto text-white">
